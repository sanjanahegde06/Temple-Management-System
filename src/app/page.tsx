...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen w-full bg-amber-50 overflow-hidden">
      ...
      {/* 2. THE WARM OVERLAY (Ensures text remains readable over the photo) */}
      ...
      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-6xl flex-col lg:flex-row">
        ...
        {/* Left Side Content */}
        <section className="relative flex flex-1 flex-col justify-between px-8 py-12 lg:px-12">
          <div className="relative flex flex-col gap-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                {/* Changed text color slightly darker to contrast with the new background */}
            ...
            <div className="flex max-w-md flex-col gap-4 rounded-3xl border border-white/60 bg-white/30 p-6 shadow-[0_8px_32px_0_rgba(217,119,6,0.1)] backdrop-blur-lg transition-all hover:bg-white/40">
              <div>
                ...
                <p className="text-xs font-medium text-amber-950/70">
                  Temple operations, bookings, donations, reports, and more.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3 text-xs font-semibold text-amber-950/80">
                <span className="rounded-full bg-white/50 px-3 py-2 border border-white/40 shadow-sm">
                  Role-Based Access
                </span>
                <span className="rounded-full bg-white/50 px-3 py-2 border border-white/40 shadow-sm">
                  Staff Directory
          ...
          <div className="relative mt-10 flex items-center gap-3 text-xs font-semibold text-amber-950/70">
            <span className="h-px w-8 bg-amber-500" />
            Guided onboarding for temple admins
          </div>
        </section>
          ...
          <div className="w-full max-w-md rounded-3xl border border-amber-200/60 bg-white/80 p-8 shadow-[0_16px_48px_0_rgba(217,119,6,0.25)] backdrop-blur-2xl ring-1 ring-white/80">
            ...
            {isSuccess && registeredTempleId ? (
              <div className="flex flex-col items-center text-center animate-in fade-in zoom-in duration-500">
                ...
                <h2 className="text-2xl font-[var(--font-display)] text-amber-950 mb-2">
              ...
              <>
                <div className="mb-6">
                  ...
                  <h2 className="text-2xl font-[var(--font-display)] text-amber-950">
                    Create the temple profile
                  </h2>
                  <p className="mt-2 text-sm font-medium text-amber-950/70">
                    Validate the essentials now. Admin credentials are required for
                    the first login.
                  </p>
                </div>
                ...
                <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
                  <FormField
                    ...
                    onChange={(event) =>
                      handleChange("templeName", event.target.value)
                    }
                    onBlur={(event) =>
                      handleBlur("templeName", event.target.value)
                    }
                  ...
                  <FormField
                    ...
                    onChange={(event) =>
                      handleChange("templeAddress", event.target.value)
                    }
                    onBlur={(event) =>
                      handleBlur("templeAddress", event.target.value)
                    }
                  ...
                  <FormField
                    ...
                    onBlur={(event) =>
                      handleBlur("adminName", event.target.value)
                    }
                  ...
                  <FormField
                    ...
                    onBlur={(event) =>
                      handleBlur("password", event.target.value)
                    }
                  ...
                  <p className="text-xs font-medium text-amber-950/60">
                    By continuing, you agree to use Firebase as the secure
